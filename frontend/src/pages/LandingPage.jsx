  ...
  return (
    <div className="landing-root">
      ...
      <section className="landing-hero">
        ...
        >
          {/* Blob 1 — large deep-left, primary midnight */}
          <Blob
            ...
            style={{
              ...
              top: '-15%',
              left: '-12%',
              background: 'radial-gradient(ellipse, rgba(10,22,40,0.9) 0%, rgba(27,44,79,0.5) 55%, transparent 80%)',
              animationDuration: '26s',
            }}
          />
          {/* Blob 2 — right accent, navy-to-blue */}
          <Blob
            ...
            style={{
              ...
              top: '10%',
              right: '-8%',
              background: 'radial-gradient(ellipse, rgba(27,44,79,0.85) 0%, rgba(45,66,112,0.4) 55%, transparent 78%)',
              animationDuration: '32s',
            }}
          />
          {/* Blob 3 — center bottom, muted accent */}
          <Blob
            ...
            style={{
              ...
              bottom: '0%',
              left: '30%',
              background: 'radial-gradient(ellipse, rgba(59,91,219,0.35) 0%, rgba(10,22,40,0.18) 55%, transparent 78%)',
              animationDuration: '20s',
            }}
          />
          {/* Blob 4 — top center, softer steel-blue */}
          <Blob
            ...
            style={{
              ...
              top: '5%',
              left: '38%',
              background: 'radial-gradient(ellipse, rgba(45,66,112,0.55) 0%, rgba(10,22,40,0.25) 60%, transparent 80%)',
              animationDuration: '28s',
            }}
          />
          {/* Blob 5 — bottom-right, subtle */}
          <Blob
            ...
            style={{
              ...
              bottom: '5%',
              right: '10%',
              background: 'radial-gradient(ellipse, rgba(27,44,79,0.6) 0%, transparent 70%)',
